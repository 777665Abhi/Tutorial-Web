...
## 106. What is the difference between Unit Tests and Instrumented UI Tests?
...
## 107. How do you test ViewModels and Coroutines using `TestDispatcher` and `runTest`?
...
## 108. What are Test Doubles (Mocks, Stubs, Fakes, Spies)?
...
## 109. How do you test Jetpack Compose UI components using `ComposeTestRule`?
...
## 110. What tools do you use for mocking API network responses (e.g., `MockWebServer`)?
...
## 111. What is Gradle configuration cache, and how does it improve build speeds?
...
## 112. Explain the difference between `implementation`, `api`, and `compileOnly` dependencies in Gradle.
...
## 113. What is `buildSrc` vs Gradle Version Catalogs (`libs.versions.toml`) for dependency management?
...
## 114. How do you set up a Continuous Integration / Continuous Deployment (CI/CD) pipeline for Android apps?
...
## 115. What is Android Debug Bridge (ADB), and what are some essential ADB commands?
...
## 116. What is Jacoco and how do you measure code coverage?
...
## 117. What is the difference between `mockk` and `mockito`?
...
## 118. How do you perform snapshot testing in Jetpack Compose (e.g., Paparazzi or Roborazzi)?
...
## 119. What is a Build Variant, and how do product flavors differ from build types?
...
## 120. How do you troubleshoot slow Gradle builds (Build Scan)?
